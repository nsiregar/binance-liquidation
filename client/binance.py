...
class BinanceWSClient:
    def __init__(self, symbols):
        ...
        for symbol in symbols:
            ...
            self.symbols[pair] = PairData(pair=pair, funding_rate=0, usd_limit=usd_limit)
    ...
    def generate_socket(self):
        ...
        streams = (f"{pair.lower()}@forceOrder/{pair.lower()}@markPrice@1s" for pair in self.symbols.keys())
    ...
    def _parse_force_order(self, data):
        ...
        elif pair_data.funding_rate > 0.07:
            emoji = ":dollar:"
        ...
        if side == "SELL":
            ...
            # Best long entries
            if pair_data.funding_rate < 0.02:
